	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 3:
				...
				break;
			case 4:
//				GradeMemberBean[] gmbs = service.getList();
//				for (int i = 0; i < gmbs.length; i++) {
...
//				}
			...
			case 5:
				...
				for( GradeMemberBean gmb : service.getGradeByName(s.next()) ) {
					System.out.println(gmb);
				}
				break;
			case 6:
				System.out.println("조회하려는 학생의 학번을 입력하시오");
